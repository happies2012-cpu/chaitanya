...
import { Mail, Github, ArrowRight, Loader2, Sparkles } from 'lucide-react';
...
export default function LoginPage() {
    ...
    return (
        <main className="min-h-screen flex bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 relative overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <motion.div
                    ...
                    className="absolute top-0 left-1/4 w-96 h-96 bg-indigo-600 rounded-full blur-[150px]"
                />
                <motion.div
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 0.1 }}
                    transition={{ duration: 1.5, delay: 0.3 }}
                    className="absolute bottom-0 right-1/4 w-96 h-96 bg-purple-600 rounded-full blur-[150px]"
                />
            </div>

            {/* Left Side - Brand Area (Desktop Only) */}
            <motion.div
                initial="hidden"
                animate="visible"
            ...
            >
                <div className="relative z-10 max-w-lg">
                    ...
                    >
                        {['Enterprise Ready', 'SSO Enabled', 'Secure by Default'].map((feature, i) => (
                            <motion.div
                                key={feature}
                                initial={{ opacity: 0, scale: 0.8 }}
                                animate={{ opacity: 1, scale: 1 }}
            ...
            <div className="flex-1 flex items-center justify-center p-6 sm:p-8 lg:p-12">
                ...
                >
                    ...
                    <motion.div
                        variants={fadeIn}
                        className="bg-slate-900/50 backdrop-blur-xl border border-white/10 p-6 sm:p-8 rounded-2xl shadow-2xl"
                    >
                        ...
                        >
                            ...
                            <motion.div variants={staggerItem}>
                                <Button
                                    type="button"
                                    variant="outline"
                                    className="w-full h-12 bg-white/5 border-white/10 hover:bg-white/10 hover:border-white/20 text-white justify-start gap-3 group transition-all duration-300"
                            ...
                            <motion.div variants={staggerItem}>
                                ...
                                >
                                    <div className="w-5 h-5 rounded-full bg-gradient-to-br from-indigo-600 to-purple-600 flex items-center justify-center text-xs font-bold">
                                        S
                                    </div>
                        ...
                        >
                            ...
                            <div className="relative flex justify-center text-sm">
                                <span className="px-4 text-slate-400 bg-slate-900/80">or</span>
                            </div>
                        </motion.div>
