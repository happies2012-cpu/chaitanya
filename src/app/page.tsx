    ...
    <main className="relative bg-background min-h-screen font-inter">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24">
            <h2 className="text-3xl md:text-4xl font-outfit font-black mb-6 uppercase tracking-tight text-foreground">
              Transparent <span className="text-gradient-orange">Case Dashboards</span>
            </h2>
          ...
          <div className="relative group">
            <div className="absolute -inset-1 bg-gradient-to-r from-orange-500 to-amber-500 rounded-[2.5rem] blur-2xl opacity-10 group-hover:opacity-20 transition duration-1000"></div>
              ...
              <div className="p-8 md:p-16 aspect-[16/10] md:aspect-[16/9] bg-background/40 relative flex items-center justify-center">
                <div className="grid grid-cols-12 gap-8 w-full h-full opacity-40 select-none pointer-events-none filter blur-[2px]">
                  ...
                  <div className="col-span-12 md:col-span-9 space-y-8">
                    <div className="grid grid-cols-3 gap-6">
                      <div className="h-32 bg-orange-500/5 border border-orange-500/10 rounded-3xl" />
                ...
                <div className="absolute inset-0 flex items-center justify-center flex-col gap-8 bg-background/20 backdrop-blur-[4px]">
                  <div className="p-10 rounded-[2.5rem] bg-card/80 border border-muted-foreground/20 shadow-3xl text-center max-w-lg mx-auto transform transition-transform group-hover:scale-[1.02]">
                    <div className="w-16 h-16 bg-gradient-to-br from-orange-500 to-amber-600 rounded-2xl mx-auto mb-6 flex items-center justify-center shadow-xl shadow-orange-500/20">
      ...
      <section className="py-40 px-6 text-center relative overflow-hidden">
        <div className="max-w-4xl mx-auto glass p-12 md:p-24 rounded-[3.5rem] border border-muted-foreground/10 shadow-[0_64px_128px_-32px_rgba(0,0,0,0.1)] relative overflow-hidden group">
          <div className="absolute inset-0 bg-gradient-to-br from-orange-500/[0.03] via-transparent to-blue-500/[0.03]" />
          <div className="absolute top-0 right-0 w-96 h-96 bg-orange-600/5 rounded-full blur-[120px] -mr-48 -mt-48 transition-all group-hover:bg-orange-600/10" />
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <h2 className="text-4xl md:text-5xl font-outfit font-black mb-8 leading-[1.1] text-foreground uppercase tracking-tight">
              Impacted by <br /> <span className="text-gradient-orange">Expert Analysis</span>.
            </h2>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-16 items-start text-left">
          <div className="md:col-span-4 space-y-8">
            <div className="flex items-center gap-4 group">
              ...
              <div className="flex flex-col -space-y-1">
                <span className="text-foreground font-outfit font-black tracking-tighter uppercase text-2xl leading-none">HORIZON<span className="text-orange-500">EB-1</span></span>
                <span className="text-[7px] text-muted-foreground font-bold uppercase tracking-[0.4em]">horizoneb1techadvisors</span>
              </div>
            </div>
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <div className="flex flex-col gap-4 text-xs font-bold uppercase tracking-widest opacity-60">
              <a href="#" className="hover:text-orange-500 transition-colors">Case Vault</a>
              <a href="#" className="hover:text-orange-500 transition-colors">Velocity Index</a>
              <a href="#" className="hover:text-orange-500 transition-colors">Strategic Map</a>
              <a href="#" className="hover:text-orange-500 transition-colors">Criteria Scan</a>
            </div>
          </div>
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <div className="flex flex-col gap-4 text-xs font-bold uppercase tracking-widest opacity-60">
              <a href="#" className="hover:text-orange-500 transition-colors">Advisory API</a>
              <a href="#" className="hover:text-orange-500 transition-colors">Privacy Node</a>
              <a href="#" className="hover:text-orange-500 transition-colors">Audit Protocol</a>
            </div>
          </div>
          ...
          <div className="md:col-span-4 space-y-6">
            ...
            <p className="text-[10px] tracking-widest font-black uppercase opacity-40">© 2025 Horizon Eb1 Advisory Group.</p>
          </div>
        </div>
      </footer>
    </main>
